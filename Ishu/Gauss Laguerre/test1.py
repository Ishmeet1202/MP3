...
def integral_simp(I1_exact,I2_exact):
    ...
    while True:
        if abs(I1_exact - mi.MySimp("exp(-x**2)/(1+x**2)",100,-100,i)) <= 10**(-3):
            I1_simp.append(mi.MySimp("exp(-x**2)/(1+x**2)",100,-100,i))
    ...
    while True:
        if abs(I2_exact - mi.MySimp("1/(1+x**2)",100,-100,i)) <= 10**(-3):
            I2_simp.append(mi.MySimp("1/(1+x**2)",100,-100,i))
